...
if($_POST){
    ...
    if(empty($nama)){
        ...
        if($insert){
            echo "<script>alert('Sukses menambahkan petugas');location.href='tampil_user.php';</script>";
        } else {
            echo "<script>alert('Gagal menambahkan petugas');location.href='tambah_user.php';</script>";
        }
    }
}
?>